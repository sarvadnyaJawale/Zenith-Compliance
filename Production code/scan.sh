...
prowler aws -M json-ocsf -F $JSON_REPORT -o /home/ubuntu/GMS-Compliance/production_code
# Step 2: Convert JSON to PDF
echo "Generating compliance reports..."
python3 /home/ubuntu/GMS-Compliance/production_code/convert_to_pdf.py $JSON_REPORT.ocsf.json
